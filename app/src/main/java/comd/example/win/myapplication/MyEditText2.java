 ...
 */
public class MyEditText2 extends AppCompatEditText implements View.OnFocusChangeListener {
    ...
    public MyEditText2(Context context, AttributeSet attrs, int defStyleAttr) {
